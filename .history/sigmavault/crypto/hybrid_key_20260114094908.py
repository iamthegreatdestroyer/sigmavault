...
try:
    from ..security.hardening import constant_time_compare, constant_time_bytes_equal
    HAS_HARDENING = True
except ImportError:
    HAS_HARDENING = False
    # Fallback implementations if hardening module not available
    import hmac
...
class HybridMixer:
    ...
    def _constant_time_compare(a: bytes, b: bytes) -> bool:
        ...
        Uses hardened implementation from security module.
        Ensures no timing leaks regardless of where bytes differ.
        ...
        """
        # Use hardened constant-time comparison
