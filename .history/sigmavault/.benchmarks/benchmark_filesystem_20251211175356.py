...
def run_filesystem_benchmarks() -> Dict[str, BenchmarkResult]:
    ...
    if HAS_CORE:
        ...
        try:
            ...
            pre_scattered = engine.scatter("pre_test", data_1kb)
