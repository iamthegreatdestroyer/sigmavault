...
class TestTransactionWrappedOperations(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.backend = ScatterStorageBackend(str(self.temp_dir))
    ...
    def test_transaction_wrapped_store_operation(self):
        ...
        self.backend.store_data(ref_id, test_data, tx_id)
        
        # Commit transaction
        self.backend.tx_manager.commit_transaction(tx_id)
        
        # Verify data was stored
        retrieved = self.backend.retrieve_data(ref_id)
    ...
    def test_transaction_wrapped_delete_operation(self):
        ...
        ref_id = "delete_test_ref"
        
        tx_store = "store_txn"
        self.backend.tx_manager.begin_transaction(tx_store)
        self.backend.store_data(ref_id, test_data, tx_store)
        ...
        self.backend.delete_data(ref_id, tx_delete)
        self.backend.tx_manager.commit_transaction(tx_delete)
        
        # Verify data was deleted
        with self.assertRaises(KeyError):
            self.backend.retrieve_data(ref_id)
    ...
    def test_transaction_rollback_on_store_failure(self):
        ...
        # Store some data
        ref1 = "rollback_ref_1"
        self.backend.store_data(ref1, b"data 1", tx_id)
    ...
    def test_transaction_rollback_on_delete_failure(self):
        ...
        try:
            ...
            self.backend.tx_manager.rollback_transaction(tx_delete)
    ...
    def test_successful_transaction_operations(self):
        ...
        with self.fs._lock:
            ...
            self.fs.write("success_test.txt", b"Hello, SigmaVAULT!", 0, fh)
        ...
        self.assertEqual(data, b"Hello, SigmaVAULT!")
