...
def sample_events():
    ...
    Generates events spread over 48+ hours to ensure enough 1-hour
    sliding window sequences for training (needs 50+ sequences).
    """
    base_time = datetime.now() - timedelta(hours=48)
    events = []
    
    # Normal pattern: regular reads spread over 48 hours
    # Generate ~8 events per hour = 384 events over 48 hours
