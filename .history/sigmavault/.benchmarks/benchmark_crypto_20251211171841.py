...
def run_crypto_benchmarks() -> Dict[str, BenchmarkResult]:
    ...
    if HAS_CRYPTO:
        ...
        try:
            ...
            # USER_ONLY mode requires passphrase
            deriver = HybridKeyDerivation(mode=KeyMode.USER_ONLY)
            deriver.initialize()  # Initialize with default salt
    ...
    if HAS_CRYPTO:
        ...
        try:
            from crypto.hybrid_key import DeviceFingerprintCollector
